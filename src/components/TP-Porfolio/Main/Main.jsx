...
const Main= () => {
    return(
         ...
         <div className='contenedorFoto'id='contenedorFoto'> 
            ...
            <p className='parrafo'>Tengo experiencia y referencias laborales comprobables.</p>
            ...
            <button className='button'><a className='botonIcono' href=""><FaDownload/></a> descarga sobre mi</button>
            </div>
            </div>
